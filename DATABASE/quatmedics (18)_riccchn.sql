...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 23, 2018 at 05:00 PM
...
('', '', 'ABCD -000001', 'BED-ABCD -000001-WARD-001-3', '3', 'hello', '200', '2018-10-09 15:11:42'),
('ABCD -000001', 'BED-ABCD -000001-WARD-001-1', '1', 'sicle cell anaemia', '50', 'WARD-001', 'occupied', '2018-10-09 13:47:10'),
('ABCD -000001', 'BED-ABCD -000001-WARD-001-2', '2', 'convolactisviscular', '70', 'WARD-001', 'occupied', '2018-10-09 13:47:31'),
('ABCD -000001', 'BED-ABCD -000001-WARD-001-3', '3', 'figaro', '33', 'WARD-001', 'occupied', '2018-10-09 15:13:37'),
('ABCD -000001', 'BED-ABCD -000001-WARD-001-4', '4', 'hvhvhvhjvjv', '300', 'WARD-001', 'occupied', '2018-10-20 13:44:14'),
('ABCD -000001', 'BED-ABCD -000001-WARD-001-5', '5', 'uuuuu', '900', 'WARD-001', 'occupied', '2018-10-20 13:44:34'),
('ABCD -000001', 'BED-ABCD -000001-WARD-001-6', '6', 'uuuuu', '900', 'WARD-001', 'occupied', '2018-10-20 13:49:55'),
('ABCD -000001', 'BED-ABCD -000001-WARD-002-1', '1', 'fjfjgkggkgjjff', '100', 'WARD-002', 'occupied', '2018-10-09 13:47:58'),
('ABCD -000001', 'BED-ABCD -000001-WARD-002-2', '2', 'Elephantiasis', '90', 'WARD-002', 'occupied', '2018-10-09 13:50:44'),
('ABCD -000001', 'BED-ABCD -000001-WARD-002-3', '3', 'hdjddjdjfj', '200', 'WARD-002', 'occupied', '2018-10-09 15:14:20'),
('ABCD -000001', 'BED-ABCD -000001-WARD-002-4', '4', 'sdf', '43', 'WARD-002', 'occupied', '2018-10-09 17:01:34');
...
('CON-ABCD -000003', 'qqqqq-000004', 'Kanfr-000001', '434', 'company', '', '', '', '55q', '444', '434444444', '533', 'ggg', 'CR-ABCD -000002', 'ABCD -000001', 'sent_to_consulting', '2018-10-17 15:43:19'),
('CON-ABCD -000004', 'dfdf-000002', 'Kanfr-000001', '24', 'private', '', '', '', '78', '987', '67', '9788', 'HJJ', 'CR-ABCD -000002', 'ABCD -000001', 'sent_to_pharmacy', '2018-10-17 15:42:49'),
('CON-ABCD -000005', 'dfdf-000002', 'Kanfr-000001', '243', 'private', '', '', '', '987', '9879', '77864', '878', 'hoh89', 'CR-ABCD -000002', 'ABCD -000001', 'sent_to_pharmacy', '2018-10-17 15:42:57'),
('CON-ABCD -000006', 'PNT-0001', 'Kanfr-000001', '768', 'company', '', '', '', '875', '756', '564', '3456', '87ghjgh', 'CR-ABCD -000001', 'ABCD -000001', 'sent_to_lab', '2018-10-17 15:43:54'),
('CON-ABCD -000007', 'qqqqq-000004', 'Uke-000002', '253', 'insurance', 'NHIS', '123587796325', '', '456', '4563', '45645', '65756', 'h  nfnf 4545', 'CR-ABCD -000001', 'ABCD -000001', 'sent_to_pharmacy', '2018-10-17 15:42:43'),
('consult-0001', 'PNT-0001', 'Kanfr-000001', '50', 'private', '', '', '', '45', '45', '45', '90', NULL, 'CR-ABCD -000001', 'ABCD -000001', 'sent_to_consulting', '2018-10-22 16:26:59'),
('consult-0002', 'PNT-0001', 'Kanfr-000001', '52', 'company', '', '', '', '25', '25', '15', '90', NULL, 'CR-ABCD -000003', 'ABCD -000001', 'sent_to_lab', '2018-10-17 15:43:59');
...
('CR-ABCD -000001', '1', 'ABCD -000001', 'occupied', '2018-09-17', '2018-10-23 14:58:44'),
('CR-ABCD -000002', '2', 'ABCD -000001', 'free', '2018-09-17', '2018-10-23 10:08:45'),
('CR-ABCD -000003', '3', 'ABCD -000001', 'occupied', '2018-09-17', '2018-10-23 09:46:01'),
('CR-ABCD -000004', '4', 'ABCD -000001', '', '2018-09-17', '2018-10-23 09:07:40');
...
(62, 'WARD-001', 'PNT-0001', 'Uke-000002', 'The patient is allergic to the dosages given', '2018-10-10 21:41:38'),
(63, 'WARD-001', 'PNT-0001', 'Uke-000002', 'nmxnmixmxnmx', '2018-10-20 15:30:26'),
(64, 'WARD-001', 'PNT-0001', 'Uke-000002', 'nknkjsjsjoos', '2018-10-20 15:32:30'),
(65, 'WARD-001', 'PNT-0001', 'Uke-000002', 'nkknknknknk', '2018-10-20 15:32:56'),
(66, 'WARD-001', 'PNT-0001', 'Uke-000002', 'j jsijijddjdjid', '2018-10-20 15:36:39'),
(67, 'WARD-001', 'PNT-0001', 'Uke-000002', 'nffnifnfif', '2018-10-20 15:37:21');
...
('ABCD -000001', 'Kanfr-000007', 'RichardQ', 'QQ', 'Kanfrahq', '2018-10-02', 'Male', 'B-negative', 'HOME', '222222', '', 'FFFF', '', '434', 'dateRegistereddateRegistereddateRegistereddateRegistered', 'VVVVVV', '', '', '', 'uploads/ABCD -000001/patient/Kanfr-000007_1539885126.png', '2018-10-18', '2018-10-18 17:52:05'),
...
(52, 'PNT-0001', 'WARD-001', 'mcmximcicc', 'kokxokxo.<br>', 'j jnjnjc.<br>', '2018-10-20 15:26:13'),
(53, 'PNT-0001', 'WARD-001', 'hhjjkkkkk', 'jajaja.<br>', 'jjaljlaja.<br>', '2018-10-20 15:32:24'),
(54, 'PNT-0001', 'WARD-001', ' ,mlmlmlm', 'kjojlojoj.<br>', 'jojojo.<br>', '2018-10-20 15:32:50'),
(55, 'PNT-0001', 'WARD-001', 'zzzzzzzzz', 'zzzzzzz.<br>', 'zzzzzz.<br>', '2018-10-20 15:36:27'),
(56, 'PNT-0001', 'WARD-001', 'nkmmmNN', 'ninii.<br>', 'ninini.<br>', '2018-10-20 15:37:16');
...
INSERT INTO `wardassigns` (`assignID`, `wardID`, `patientID`, `staffID`, `admitDate`, `dischargeDate`, `admitDetails`, `centerID`, `consultingroom`, `doe`) VALUES
...
--
ALTER TABLE `review_tb`
  MODIFY `reviewID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
--
...
--
ALTER TABLE `wardmeds`
  MODIFY `medID` int(255) NOT NULL AUTO_INCREMENT;
--
