...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    ...
    <li class="" ><a title="" href="lab-index.html"><i class="icon icon-search"></i> <span class="text">LABORATORY</span></a></li>
...
<div id="sidebar">
    <ul>
    <li class="active"><a href="medics-index.html"><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>
    </ul>
</div>
...
<div id="content">
  ...
  <div class="container">
    ...
    <ul class="quick-actions">
          <li> <a href="centerdepartment-index.html"> <i class="icon-cabinet"></i> Department</a></li>
          <li> <a href="centeruser-index.html"> <i class="icon-people"></i> Staff </a> </li>
          <li> <a href="centerward-index.html"> <i class="icon-graph"></i> Ward </a> </li>
          <li> <a href="#"> <i class="icon-home"></i> Pharmacy</a> </li>
          <li> <a href="centerlab-index.html"> <i class="icon-search"></i> Laboratory </a> </li>
        </ul>
   </div>
