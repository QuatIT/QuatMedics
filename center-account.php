...
<div id="sidebar">
    <ul>
        ...
        <li> <a href="smsrequest-index"> <i class="icon-envelope"></i> <span>SMS REQUEST</span></a> </li>
    </ul>
</div>
<div id="content">
                    ...
                    <form action="#" method="post" class="form-horizontal">
						  <table class="table table-bordered" id="dynamic_field4">
							...
							<tr>
								...
								<td><button type="button" name="add" id="add4" class="btn btn-primary">Add Account</button></td>
							</tr>
						</table>
						  <div class="form-actions">
							  <i class="span5"></i>
							  <button type="submit" name="saveAccount" class="btn btn-primary labell btn-block span6"> Save Account</button>
						  </div>
              		</form>
				</div>
				<div class="span6">
        ...
        <div id="tab2" class="tab-pane">
                    ...
                    <form action="#" method="post" class="form-horizontal">
						  <table class="table table-bordered" id="dynamic_field2">
							...
							<tr>
								...
								<td><button type="button" name="add" id="add2" class="btn btn-primary">Add</button></td>
							</tr>
						</table>
						  <div class="form-actions">
							  <i class="span5"></i>
							  <button type="submit" name="saveServiceprices" class="btn btn-primary labell btn-block span6"> Save Prices</button>
						  </div>
              		</form>
				</div>
            ...
            <div class="row-fluid">
                    ...
                    <form action="#" method="post" class="form-horizontal">
						  ...
						  <div class="form-actions">
							  <i class="span5"></i>
							  <button type="submit" name="saveLabPrices" class="btn btn-primary labell btn-block span6"> Save Prices</button>
						  </div>
              		</form>
				</div>
