...
$patients_view = select("SELECT * FROM insure_data where insurancetype='$insurance' && dateinsert between '$datefrom' AND '$dateto' ");
...
//consultation
$consultation_query = select("select * from consultation where patientID='".$patient_row['patientid']."' && dateinsert='".$patient_row['dateinsert']."' && consultID='".$patient_row['consultID']."' ");
foreach($consultation_query as $consult_row){}


//diagnosis
$diagnosis = select("select * from diagnose_tb where patientID='".$patient_row['patientid']."' && dateRegistered='".$patient_row['dateinsert']."' && consultID='".$patient_row['consultID']."' ");

$diagnose_count = '1';


//medicine
$medis = select("select * from insure_med_frequency where patientid='".$patient_row['patientid']."' && dateinsert='".$patient_row['dateinsert']."'  && consultID='".$patient_row['consultID']."' ");
...
$investigations = select("select * from labresults where patientID='".$patient_row['patientid']."' && dateInsert='".$patient_row['dateinsert']."'  && consultID='".$patient_row['consultID']."' ");
...
-->
                  ...
                  <tbody>
                    <tr>
                      <td><Strong>A.</Strong> Select only one <br>
                        				...
                        				<?php
                        						$search_consultation = select("select * from consultation where patientID='".$patient_row['patientid']."' && dateInsert='".$patient_row['dateinsert']."' && consultID='".$patient_row['consultID']."' ");
                                      ...
                                      <label class="form-check-label" for="out_patient"> Out-Patient </label>
                        				...
                        				<?php
                        						$search_ward = select("select * from wardassigns where patientID='".$patient_row['patientid']."' && dateInsert='".$patient_row['dateinsert']."' && consultID='".$patient_row['consultID']."' ");
                                      ...
                                      <label class="form-check-label" for="in_patient"> In-Patient </label>
                        				...
                        				<?php
                        						$search_prescriptions = select("select * from prescriptions where patientID='".$patient_row['patientid']."' && dateInsert='".$patient_row['dateinsert']."' && consultID='".$patient_row['consultID']."' ");
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td><?php $inpatient = select("select * from tariff where servicename='ward' and dateinsert between '$datefrom' and '$dateto' and insurancetype='$insurance' "); foreach($inpatient as $in_patient){} echo @$in_patient['price']; ?></td>
    </tr>
    <tr>
